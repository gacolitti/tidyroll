# Getting help with tidyroll

Thanks for using tidyroll. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/tidyroll/issues) to make sure the 
